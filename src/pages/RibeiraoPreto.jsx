...
function RibeiraoPreto() {
    return (
        <div className="min-h-screen font-sans bg-white selection:bg-brand-cyan selection:text-brand-navy">
            <Header city="Ribeirão Preto" state="SP" />

            <main>
                <Hero videoSrc="/videos/hero-padrao-apos-ribeirao.mp4" city="Ribeirão Preto" noTilt />
                <PainSolution />
                <Benefits city="Ribeirão Preto" />
                <Guarantee />
                <CTAFinal city="Ribeirão Preto" />
            </main>
