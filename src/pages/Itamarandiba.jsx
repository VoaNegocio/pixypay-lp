...
function Itamarandiba() {
    return (
        <div className="min-h-screen font-sans bg-white selection:bg-brand-cyan selection:text-brand-navy">
            <Header city="Itamarandiba" state="MG" />

            <main>
                <Hero videoSrc="/videos/hero-padrao-apos-ribeirao.mp4" city="Itamarandiba" noTilt />
                <PainSolution />
                <Benefits city="Itamarandiba" />
                <Guarantee />
                <CTAFinal city="Itamarandiba" />
            </main>
